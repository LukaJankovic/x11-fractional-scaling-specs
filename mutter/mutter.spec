...
# Fractional scaling on X11 using xrandr
Patch3:        0001-x11-Add-support-for-fractional-scaling-using-Randr.patch
...
%changelog
* Mon Aug 30 2021 Luka Jankovic <lukjan1999@gmail.com> - 40.4-1
- Added xorg fractional scaling patch
